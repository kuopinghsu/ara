  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  /* Initializations */
#ifndef HAVE_MALLOC
  static Rec_Type rec1;
  static Rec_Type rec2;
  Next_Ptr_Glob = (Rec_Pointer) &rec1;
  Ptr_Glob = (Rec_Pointer) &rec2;
#else
  ...
  else
  {
    ...
    printf ("%d.%03d \n", (int)Microseconds, (int)(Microseconds * 1000)%1000);
    printf ("Dhrystones per Second:                      ");
    printf ("%d.%03d \n", (int)Dhrystones_Per_Second, (int)(Dhrystones_Per_Second*1000)%1000);
    printf ("\n");
  }
